...
public class ClienteModel extends Base<Cliente, Integer> implements IClienteModel{
	...
	public ArrayList<Cliente> listarClienteComDebito(Debito debito) throws  Exception{
		TypedQuery<Cliente> Clientes = this.em.createQuery("Select c.cliente from Debito c where c.status = "+ debito.getStatus()+" and c.vencimento = "+debito.getVencimento(), Cliente.class);
